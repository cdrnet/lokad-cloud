...
namespace Lokad.Cloud.Management
{
    ...
    public class CloudServiceScheduling
    {
        ...
        /// </summary>
        public CloudServiceScheduling(IBlobStorageProvider blobStorage)
        {
            _blobs = blobStorage;
        ...
        public List<CloudServiceSchedulingInfo> GetSchedules()
        {
            ...
            return _blobs.ListBlobNames(ScheduledServiceStateName.GetPrefix())
                .Select(name => Tuple.Create(name, _blobs.GetBlob(name, _runtimeFormatter)))
        ...
        {
            var blob = _blobs.GetBlob(new ScheduledServiceStateName(serviceName), _runtimeFormatter);

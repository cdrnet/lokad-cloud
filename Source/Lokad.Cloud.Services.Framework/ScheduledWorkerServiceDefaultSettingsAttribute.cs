...
{
    /// <summary>
    /// Default settings for scheduled worker services. The actual settings can be overriden
    ...
    /// </summary>
    /// <seealso cref="ScheduledWorkerService"/>
    [AttributeUsage(AttributeTargets.Class, Inherited = true, AllowMultiple = false)]
    public sealed class ScheduledWorkerServiceDefaultSettingsAttribute : Attribute
    {
        /// <summary>
